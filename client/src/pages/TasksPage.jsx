...
const TasksPage = () => {
  ...
  useEffect(() => {
    const fetchTasksData = async () => {
      try {
        ...
        const { data } = await axios.get('https://taskmanager-900c.onrender.com/task/getalltasks', config);
  ...
  const handleDelete =async (taskId) => {
    try {
      ...
      await axios.delete(`https://taskmanager-900c.onrender.com/task/delete/${taskId}`, config);
