...
const socket = io('https://taskmanager-900c.onrender.com/task');
...
const [project, setProject] = useState('');
    ...
    const fetchTask = async() => {
        try {
            ...
            const { data } = await axios.get(`https://taskmanager-900c.onrender.com/task/${taskId}`, config);
            // console.log(data);
    ...
    const handleEditTask = async () => {
        try {
            ...
            // console.log(project, assignedTo, title, description);
            await axios.patch(`https://taskmanager-900c.onrender.com/task/update/${taskId}`,updateData , config);
            // console.log(data);
